...
namespace WebApplication1.Controllers
{
    ...
    public class GenericController : ControllerBase
    {
        ...
        public GenericController(HttpRequestParser httpRequestParser, IReceiveHttpCommand commandReceiver, IReceiveHttpQuery queryReceiver, IReceiveHttpEvent eventReceiver)
        {
