...
//{
//    public interface IRecordEvent : IPostHandleEvent
//    {
...
//        public RecordedEvent(DateTime timeStamp, IEvent @event)
//        {
//            TimeStamp = timeStamp;
//            Event = @event;
//        }
...
//        public async Task PostHandleAsync(IEvent @event, CancellationToken cancellationToken = default)
//        {
//            RemoveExpiredEvents();
...
//            lock (_lockObj) {
//                _events.Add(new RecordedEvent(_clock.UtcNow, @event);
//            }
...
//                lock (_lockObj) {
//                    foreach (var task in _tasks.Where(x => @event.GetType() == x.EventType && x.EventFilter(@event))) {
