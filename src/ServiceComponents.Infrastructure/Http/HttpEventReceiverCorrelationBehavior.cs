...
namespace ServiceComponents.Infrastructure.Http
{
    public class HttpEventReceiverCorrelationBehavior : HttpReceiverCorrelationBehavior, IReceiveHttpEvent
    {
        ...
        public HttpEventReceiverCorrelationBehavior(ILogger log, IHttpContextAccessor httpContextAccessor, IOptions<HttpRequestOptions> httpRequestOptions, CorrelationContext.Correlation correlation, IReceiveHttpEvent next) 
